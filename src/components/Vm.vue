    ...
    <el-table-column align="right">
      ...
      <template slot-scope="scope">
        ...
        <el-button
          ...
          <el-link style="margin-left: 10px;" :href="MaxCloudUrl+'/vnc?token='+scope.row.vnc_token" target="_blank" icon="el-icon-connection" :underline="false">VNC</el-link>
      </template>
    </el-table-column>
  </el-table>
</template>
        ...
        .then(function (res){
          ...
          if (data.RespHead.ErrorCode==0 && data.RespHead.Message=="SUCCESS"){
            $.each(self.tableData, function(index, vm_data){
              if (vm_data && vm_data["uuid"] == vm_uuid){
