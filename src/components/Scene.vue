<template>
  <el-row>
    <el-col :span="3" :offset="2">
      <div style="height:800px;background-color: red;margin-top: 30px"></div>
    </el-col>
    <el-col :span="14" style="text-align: left;">
      ...
      <div style="height: 800px;border:1px solid blue;" id="canvas" />
    </el-col>
    <el-col :span="5">
      <div style="height:800px;background-color: red;margin-top: 30px"></div>
    </el-col>
    ...
    return {
      ...
      json_str: {
        nodes: [
          ...
          { name: "Qunee", x: 100, y: 50, img: "Q-exchanger" }
        ],
